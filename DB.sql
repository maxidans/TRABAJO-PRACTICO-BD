...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `crear_usuario` (IN `id` VARCHAR(10), IN `nombre` VARCHAR(50))   BEGIN
...
,{"type":"table","name":"prestamo","database":"tp1","data":
[


]
}
,{"type":"table","name":"usuario","database":"tp1","data":
[
{"carnet_usuario":"U001","nombre_usuario":"Ana Lopez"},
{"carnet_usuario":"U002","nombre_usuario":"Luis Perez"}
]
}
]
